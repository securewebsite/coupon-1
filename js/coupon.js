var host = "http://www.dface.cn";

function getcoupon(){
	status('/wapp/coupon_downs',{status:"1"});
...
$("#aUsed").click(function(){
	status('/wapp/coupon_downs',{status:"2"});
...
$("#invalid").click(function(){
	status('/wapp/coupon_downs',{status:"3"});
	pipEffects();
	statusValue = 3;
});
...
$("#allzt").click(function(){
	status('/wapp/coupon_downs',{status:"0"});
	pipEffects();
	statusValue = 0;
});
//所有类型
$("#alllx").click(function(){
	status('/wapp/coupon_downs',{type:"0"});
	pipEffects();
	typeValue = 0;
});
...
$("#myCoupon").click(function(){
	status('/wapp/coupon_downs',{type:"1"});
	pipEffects();
	typeValue = 1;
});
...
$("#freeCoupon").click(function(){
	status('/wapp/coupon_downs',{type:"2"});
	pipEffects();
	typeValue = 2;
});
